(() => {
    var e = {
            ...
            47: function(e, t, r) {
                ...
                ! function(n, o) {
                    ...
                    var a = "function",
                        ...
                        J = function(e, t) {
                            ...
                            return this.getBrowser = function() {
                                ...
                                var e = {};
                                return e[b] = o, e[p] = o, X.call(e, i, y.os), x && !e[b] && h && "Unknown" != h.platform && (e[b] = h.platform.replace(/chrome os/i, _).replace(/macos/i, V)), e
                    ...
                    J.VERSION = "1.0.37", J.BROWSER = $([b, p, u]), J.CPU = $([w]), J.DEVICE = $([d, m, f, h, g, y, v, x, k]), J.ENGINE = J.OS = $([b, p]), typeof t !== s ? (e.exports && (t = e.exports = J), t.UAParser = J) : r.amdO ? (i = function() {
                        return J
    ...
    r.amdO = {}, r.n = e => {
        ...
        const m = "production",
            p = "0.0.475",
            w = "bf0a1c21w381382fdp2197aec3mf9663592",
            h = "sbf0a1c21w381382fdp2197aec3mf9663592m.js";
        var g = r(482),
            v = r.n(g);
            ...
            O = (e, t) => {
                try {
                    ...
                    const c = function(t, {
                        ...
                        l = k[m];
                    var i;
                    if (!l) return void(null == (i = console) || i.log(`[${m}]`, "Bugsnag notify:", c));
                    fetch(l, {
                        method: "POST",
                        headers: {
        ...
        function B(e) {
            ...
            function({
                ...
                const r = P(t, e.browser.localStorage);
            ...
            function({
                ...
                const r = P(t, e.browser.sessionStorage);
        ...
        const j = new URL(self.location.href);
        ...
        function F(e) {
            const t = new URL(e);
            if ("https:" !== t.protocol) throw new U(`URL must be secure (HTTPS): ${t.href}`);
            const r = j.host.replace(/[/\-\\^$*+?.()|[\]{}]/g, "\\$&");
            if (new RegExp(`^${j.protocol}//(.*@)?${r}`, "i").test(t.href)) throw new D(`Request are not allowed to the same origin: ${t.href}`);
            return t
        }
        const W = Function.prototype.call.bind(XMLHttpRequest.prototype.open);
                ...
                try {
                    ...
                    if (Array.isArray(n)) {
                        ...
                        q(i, function(e) {
                            const t = new Set;
                            let r = e;
                            for (; r;) Object.getOwnPropertyNames(r).forEach((e => t.add(e))), r = Object.getPrototypeOf(r);
                            return Array.from(t)
                        }(i).reduce(((r, i) => {
                            var n;
                            return r[i] = null != (n = t[i]) ? n : e, r
                        }), {}))
                    } else i = !0 === n ? void 0 : n;
                    R(e, r, {
                        value: i
        ...
        Object.defineProperty(self, "webPixelsManager", {
            value: {
                createShopifyExtend: () => ({
                    extend: async (e, t) => {
                        if ("WebPixel::Render" !== e) throw new z;
                        X = t
                    }
                })
            },
        ...
        const K = async e => {
            ...
            if (Y) {
                ...
                throw O(e, {
                    ...
                    sandboxUrl: j.href || "unknown"
                }), e
            }
            Y = !0, a(o), a(s);
            try {
                H && (o.browser.sendBeacon = E), H || (B(e), self.document.title = r)
            } catch (l) {
                throw O(l, {
                    pixelId: i.id,
                    pixelType: i.type,
            ...
            return await (null == (t = X) ? void 0 : t.call(o, o)), {
                status: "success",
                hashVersion: w,
                sandboxUrl: j.href || "unknown"
            }
        ...
        ! function() {
            ...
            try {
                (function(e, {
                    ...
                    function h() {
                        var e;
                        o = !0, s.clear(), c.clear(), null === (e = u.terminate) || void 0 === e || e.call(u), a.removeEventListener("message", m)
                    }
                })(H ? self : function({
                    targetOrigin: e = "*"
                } = {}) {
...
importScripts('/wpm/strict/app/web-pixel-shopify-app-pixel@064.js');