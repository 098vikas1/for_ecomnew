! function() {
    var e = {
            3177: function(e, t) {
                ...
                }, t.defineProperty = r, t.objectSpread2 = function(e) {
            ...
            7560: function(e, t, n) {
                ...
                t.CMP_ANSWERS_COOKIE_NAME = i, t.analyticsProcessingAllowed = function() {
                    return s(o.DataProcessingPurpose.ANALYTICS)
                }, t.marketingProcessingAllowed = function() {
                    return s(o.DataProcessingPurpose.MARKETING)
                }, t.preferencesProcessingAllowed = function() {
                    return s(o.DataProcessingPurpose.PREFERENCES)
                }, t.saleOfDataAllowed = function() {
                    return s(o.DataProcessingPurpose.SALE_OF_DATA)
            ...
            5841: function(e, t, n) {
                ...
                function s() {
                    ...
                    if (void 0 !== e && ! function(e) {
                            ...
                            const t = Object.keys(e).filter((e => "region" !== e && "lim" !== e && "cus" !== e));
                ...
                }, t.getCMPConsentValues = u, t.getCustomValue = function(e) {
                    const t = c();
                    if (d(t) || !t.cus) return;
            ...
            8920: function(e, t, n) {
                ...
                function p(e) {
                    return e ? f() ? document.referrer : "" : null
                }

                function l(e) {
                    return e ? f() ? window.location.pathname + window.location.search : "/" : null
                }
                ...
                t.saleOfDataRegion = a.saleOfDataRegion, t.GPCSignal = g, t.doesMerchantSupportGranularConsent = function() {
                    return !0
                }, t.getCCPAConsent = v, t.getCustomConsent = function(e) {
                    return i.getCustomValue(e)
                }, t.getLandingPageData = l, t.getRegion = function() {
                ...
                }, t.getTrackingConsent = d, t.hasConsentForGDPR = h, t.haveAnalyticsConsent = function() {
                ...
                }, t.isBuyerOnFirstPageOfVisit = f, t.isRegulationEnforced = function() {
                    ...
                    return c.updateTrackingConsent({
                        ccpa_consent: e
                    }, t)
                }, t.setCustomConsent = function(e, t) {
                    return s.setCustomConsent(e, t)
                }, t.setTrackingConsent = function(e, t) {
                    if (t || (t = () => console.warn("setTrackingConsent should use a callback because it is an async function. Use an empty callback to silence the warning.")), i.validCookieDoesNotExist() && console.warn("Shop is not configured to block privacy regulation in online store settings."), function(e) {
                    ...
                    if ("object" == typeof e) {
                        const n = p(e.analytics),
                            r = l(e.analytics);
                        return (e.storefrontAccessToken ? u.headlessUpdateTrackingConsent : c.updateTrackingConsent)(o.objectSpread2(o.objectSpread2({
                            granular_consent: e
                        }, null !== n && {
                            referrer: n
                        }), null !== r && {
                        ...
                        const n = p(e),
                            r = l(e);
                        return c.updateTrackingConsent(o.objectSpread2(o.objectSpread2({
                            consent: e
                        }, null !== n && {
                            referrer: n
                        }), null !== r && {
                    ...
                    return console.warn("shouldShowCCPABanner is deprecated and will be removed."), a.saleOfDataRegion() && v() === r.DisplayConsentValues.NO_INTERACTION
                }, t.shouldShowGDPRBanner = function() {
                    return a.shouldShowBanner() && d() === r.DisplayConsentValues.NO_INTERACTION
                }, t.userCanBeTracked = function() {
                    return !!i.validCookieDoesNotExist() || h()
            ...
            1449: function(e, t) {
                ...
                Object.defineProperty(t, "__esModule", {
                ...
                }, t.writeCookie = function(e, t, o, r) {
                    ...
                    let i = `${e}=${r}`;
                    i += "; path=/", t && (i += `; domain=${t}`), i += `; expires=${new Date((new Date).getTime()+o).toUTCString()}`, i += "; secure", document.cookie = i
                }
            },
            5814: function(e, t, n) {
                "use strict";
            ...
            8250: function(e, t, n) {
                ...
                function i() {
                    return (i = o.asyncToGenerator((function*(e) {
                        const t = {
                            headers: {
                                "content-type": "application/json",
                                "x-shopify-storefront-access-token": e.token
                            },
                            body: JSON.stringify({
                                query: e.query,
                                variables: {}
                        ...
                        return fetch(`https://${e.domain}/api/unstable/graphql.json`, t).then((e => {
                            if (e.ok) return e.json();
                            throw new Error("Server error")
                        }))
                ...
                function a() {
                    return (a = o.asyncToGenerator((function*(e, t) {
                        return r({
                            query: `query setCustomConsent {\n     consentManagement {\n        customConsentSet(customConsents: [${e.map((function(e){const t=encodeURIComponent(e.key),n=encodeURIComponent(e.value);return e.value?`{key: "${t}", value: "${n}"}`:`{key: "${t}", value: null}`})).join(",")}]) {newTrackingConsentCookie cookieDomain}}}`,
                            domain: window.location.host,
                            token: t || function() {
                                const e = document.documentElement.querySelector("#shopify-features");
                                if (!e) return void console.warn("Could not find liquid access token");
                ...
                t.rawAPIQuery = r, t.setCustomConsent = function(e, t) {
            ...
            6304: function(e, t) {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    ACCEPTED: "1",
                    DECLINED: "0"
                }, t.CookieKeys = ["v", "con", "reg"], t.CookieVersion = "2.1", t.DataProcessingPurpose = {
                    PREFERENCES: "p",
                    ANALYTICS: "a",
                    MARKETING: "m",
                    SALE_OF_DATA: "t"
            ...
            3653: function(e, t, n) {
                ...
                var y = function(e) {
                    function n(t, o, r) {
                        ...
                        return a.pageID = h.default.microSessionId, a
                    }
                    return r(n, e), n.prototype.name = function() {
                        ...
                        return i(i({}, t), {
                            ...
                            checkout_token: h.default.checkoutToken,
                            deprecated_visit_token: h.default.visitToken,
                            session_id: g.getSessionId(),
                            asset_version_id: "dd626a6a6fbdab104f8779acc4331c330134c832",
            ...
            6997: function(e, t, n) {
                    ...
                    if (void 0 === o)
                        if (function() {
                            ...
                            for (var t = "", n = 0, r = d.hostname().split(".").reverse(); n < r.length; n++) {
                                ...
                                if (_(e, a, 0, t), y(e, a)) return void(o = t)
                            }
                            o = ""
                        }
                }
                ...
                t.parseDocumentCookie = g, t.cookieImpl = {
                    parse: g,
                    read: function(e) {
                    ...
                    write: function(e, n, o) {
                        if (void 0 === o && (o = {}), t.cookieImpl.enabled() && t.cookieImpl.allowed(e)) {
                            ...
                            o.maxage && (o.maxage < 0 ? o.expires = h : o.expires = new Date((new Date).getTime() + o.maxage)), o.path && (r += "; path=" + o.path), o.domain && (r += "; domain=" + o.domain), (o.maxage < 0 || o.expires) && (r += "; expires=" + o.expires.toUTCString()), o.samesite ? r += "; SameSite=" + o.samesite : r += "; SameSite=Lax", o.secure && (r += "; secure");
                            try {
                    ...
                    void 0 === r && (r = "Lax"), v(e), _(e, t, n ? 31104e6 : 18e5, o, r)
                }, t.clear = function(e) {
                    v(e), _(e, "", -1, o), _(e, "", -1, "")
            ...
            2971: function(e, t, n) {
                ...
                t.metricsSchemaId = "trekkie_metrics/2.0", t.errorsSchemaId = "trekkie_errors/2.0", t.setGlobalSerializedAppConfig = function(e) {
                    ...
                    if (this.shouldSendToBugsnag()) {
                        var n = "dd626a6a6fbdab104f8779acc4331c330134c832",
                            o = null,
                            r = null,
                            i = null;
                        if (e.appConfig) try {
            ...
            9426: function(e, t, n) {
                    ...
                    _ = function() {
                        ...
                        return e.prototype.configureMonorailRegion = function(e) {
                            ...
                            a.addBatchEvent({
                                ...
                                payload: {
                                    build_id: "dd626a6a6fbdab104f8779acc4331c330134c832",
                            ...
                            r && window.addEventListener("message", (function(e) {
                                ...
                                try {
                                    ...
                                    h.reportError("buyWithPrimeError", e)
                                }
                            }))
                            ...
                            g.default.refreshVisitorTokens(), this.integrations.forEach((function(t) {
                ...
                t.Tricorder = _, t.replayAnalyticsQueue = function(e, t) {
            ...
            803: function(e, t, n) {
                ...
                const o = "sh",
                    ...
                    h = "checkout_contact_step_started",
                    g = "checkout_contact_info_submitted",
                    v = "checkout_address_info_submitted",
                    y = "checkout_shipping_step_started",
                    _ = "checkout_shipping_info_submitted",
                ...
                function S() {
                    ...
                    e.Shopify = e.Shopify || {}, e.Shopify.evids || (A = {
                        ...
                        if (!A[e] || (null == t ? void 0 : t.analyticsFramework) !== T && (null == t ? void 0 : t.analyticsFramework) !== C) return P(r);
    ...
    n.d = function(e, t) {
        ...
        function() {
            ...
            i.push(["S2S", h.S2S]);
            try {
                var g = window[r].config;
                if (g) {
                    t.setGlobalSerializedAppConfig(JSON.stringify(g));
                    var v = window[r],
                        y = window.trekkie = new e.Tricorder(i, g, (function() {
                            window[r] = y, window._visit = {
                                tag: function() {},
