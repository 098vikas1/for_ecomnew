class PredictiveSearch extends HTMLElement {
    ...
    getSearchResults(searchTerm) {
        ...
        // console.log(this.updateViewAllLink(searchTerm))
    ...
    getResultsMaxHeight() {
        this.resultsMaxHeight = window.innerHeight - document.querySelector('[id^="shopify-section-header"]').getBoundingClientRect().bottom;
    ...
    close(clearSearchTerm = false) {
        ...
        this.isOpen = false;
        this.searchDetails.removeAttribute('open', true);
    }
